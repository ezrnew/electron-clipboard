...
function windowStickToBorderHandler(window) {
    ...
    window.on('move', () => {
        ...
        // const cursorPositionFromRight = windowBounds.x + windowBounds.width - cursorPosition.x;
        // const cursorPositionFromRight = windowBounds.x + windowBounds.width - cursorPosition.x;
        const displayBounds = electron_1.screen.getDisplayMatching(windowBounds).bounds;
...
exports.windowStickToBorderHandler = windowStickToBorderHandler;
