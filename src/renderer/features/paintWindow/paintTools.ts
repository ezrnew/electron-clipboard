class PaintTools {
  ...
  private initializeToolsListeners() {
    ...
    colorButtonYellowgreen.addEventListener('click', () => {
      this._color = '#ADFF2F';
    });
    colorButtonGreen.addEventListener('click', () => {
      this._color = '#008000';
    });
    colorButtonTeal.addEventListener('click', () => {
      this._color = '#008080';
    });
    colorButtonBlue.addEventListener('click', () => {
      this._color = '#0000FF';
    });
    colorButtonViolet.addEventListener('click', () => {
      this._color = '#EE82EE';
    });
    ...
    colorButtonGray100.addEventListener('click', () => {
      this._color = '#232323';
    });
    colorButtonGray200.addEventListener('click', () => {
      this._color = '#484848';
    });
    colorButtonGray300.addEventListener('click', () => {
      this._color = '#6F6F6F';
    });
    colorButtonGray400.addEventListener('click', () => {
      this._color = '#909090';
    });
    colorButtonGray500.addEventListener('click', () => {
      this._color = '#BCBCBC';
    });
    colorButtonGray600.addEventListener('click', () => {
      this._color = '#D3D3D3';
    });
    ...
    paintWidth1.addEventListener('click', () => {
      this._drawingWidth = 2;
    });
    paintWidth2.addEventListener('click', () => {
